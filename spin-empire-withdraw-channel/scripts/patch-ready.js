...
if (!source.includes('instanceId:activityInstanceId,guildId')) throw new Error('Guild-aware Activity login was not applied.');
...
console.log(`Patched client with guild-aware /casino verification (${BUILD_MARKER}).`);
